...
const EditProduct = () => {
  ...
  const editproduct = (e) => {
    e.preventDefault()
    axios.put(`http://localhost:3030/products/updateproducts/${product_name}`, {
        product_name,
        image,
        price,
        description
     ...
     <UserNav/>
      ...
      <div className='driverReg-container'>
        <div className='driverReg-info'>
          <h2 className='driver-h2'>Edit Products</h2>
        </div>
        ...
        <form action=''>
          <div className='driver-container'>
            ...
            <div class='driver-submit'>
              <button className='driver-btn' onClick={editproduct}type='submit'>
                Submit
              </button>
            </div>
          </div>
